...
begin
  repeat
    ...
    if ( FSourceBuf[ FSourcePos ] in [ '0'..'9' ] ) or
       //kt ( ( FSourceBuf[ FSourcePos ] = '-' ) and ( FSourceBuf[ FSourcePos + 1 ] in [ '.', '0'..'9' ] ) ) then
       ( ( FSourceBuf[ FSourcePos ] = '-' ) and CharInSet(FSourceBuf[ FSourcePos + 1 ], [ '.', '0'..'9' ] ) ) then     //kt
    begin

      {integer numbers}
      FTokenBuf.Write( FSourceBuf[ FSourcePos ] );
      Inc( FSourcePos );
      //kt while FSourceBuf[ FSourcePos ] in [ '0'..'9' ] do
      while CharInSet(FSourceBuf[ FSourcePos ], [ '0'..'9' ]) do  //kt
      begin
        FTokenBuf.Write( FSourceBuf[ FSourcePos ] );
        Inc( FSourcePos );
      ...
      //kt while ( FSourceBuf[ FSourcePos ] in [ '0'..'9', 'e', 'E', '+', '-' ] ) or
