...
type
  ...
  private
    ...
    //kt function  GetHTMLText:string;
    function  GetHTMLText: String;
    //kt procedure SetHTMLText(HTML:String);
  ...
  public
    ...
    //kt property  HTMLText:string read GetHTMLText write SetHTMLText;
    ...
    procedure Print(PromptWithPrinterDlg : boolean = true);
...
//kt function THtmlObj.GetHTMLText:string;
...
procedure THtmlObj.Print(PromptWithPrinterDlg : boolean = true);
//kt added 2/2018
var
  vaIn, vaOut: OleVariant;
  PromptOption : longint;
begin
  if PromptWithPrinterDlg then begin
    PromptOption := OLECMDEXECOPT_PROMPTUSER;
  end else begin
    PromptOption := OLECMDEXECOPT_DONTPROMPTUSER;
  end;
  ControlInterface.ExecWB(OLECMDID_PRINT, PromptOption, vaIn, vaOut);
end;

procedure THtmlObj.PrintPreview;
//kt added 2/2018
var
  vaIn, vaOut: OleVariant;
begin
